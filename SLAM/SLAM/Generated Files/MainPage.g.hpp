...
void ::SLAM::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::SLAM::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::SLAM::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
